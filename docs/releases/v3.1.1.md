...
- In the current submit release lane, the only public Vibe entry is `vibe`. Older `vibe-upgrade` wording in earlier release materials is historical context, not the current public install surface.
