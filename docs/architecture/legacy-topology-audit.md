...
The retired exact-output golden gate has also been removed. The retained router is a compatibility candidate audit, checked by runtime smoke and current-routing debt verification rather than frozen selected rows or scores.
