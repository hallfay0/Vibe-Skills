...
<a href="./docs/install/README.md">
  <img src="./docs/assets/install-cta-cn.svg" width="248" height="42" alt="安装 VibeSkills">
</a>
...
<h2 align="center">VibeSkills 如何把任务推进到可交付</h2>
...
<h2 align="center">本地 Skills 如何参与任务</h2>
...
<h2 align="center">任务中断后怎样继续，完成后怎样复查</h2>
...
<h2 align="center">使用 VibeSkills</h2>

使用时，把 VibeSkills 当作普通 Skill 调用即可。根据你使用的 AI 工具，输入 `$vibe` 或 `/vibe`。

VibeSkills 会扫描 Skills 安装目录，以及你配置的其他本地 Skill 目录，找到当前可用的 Skills。

它会根据任务选择合适的 Skills，安排到对应工作中，再统一推进和检查结果。你不需要自己记住每个 Skill 应该在什么时候使用。
