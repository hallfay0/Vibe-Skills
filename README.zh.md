...
<picture>
  ...
  <img src="./docs/assets/readme-tagline-cn-light.svg" width="680" alt="组织合适的本地 Skills，把复杂任务做完整。">
</picture>
...
<a href="./docs/install/README.md">
  <img src="./docs/assets/install-cta-cn.svg" width="292" height="50" alt="安装 VibeSkills">
</a>
...
Skills 是优秀的实践资产，但任务一复杂，Agent 往往会反复调用最容易触发的几个，其余 Skills 很少被安排进计划；多个 Skills 一起参与时，分工和结果也容易接不上。VibeSkills 想做的，就是在规范化的 harness 框架下，**充分组织和调度这些已经存在的资源**。

它参考了 Superpowers 和 GSD-Lite 的 harness 方式，形成一套包含**完整流程与状态机**的工作框架，把需求确认、执行规划、Skills 组织、按 harness 框架执行、测试与评估连接为一个整体。最终，VibeSkills 希望为用户提供完成具体任务的**端到端交付体验**，降低使用 AI 时的认知负担和门槛，让用户不再担心已经下载却暂时不常用的 Skills 被闲置，也不再需要反复记忆**应该在什么任务中使用哪些 Skills**。
...
<h2 align="center">VibeSkills实践案例：完成一项机器学习实验</h2>
...
<p align="center"><strong><a href="./docs/install/README.md">打开完整安装说明</a></strong></p>
